        ...
        sidebarPanel =
          shiny::sidebarPanel(
            ...
            shiny::conditionalPanel(
              condition = "input.highlight_mode=='Manually selected rows'&input.map_type=='Static'",
              shiny::checkboxInput(
                inputId = "only_selected",
                label = "Show only selected rows",
                value = FALSE
              )
            ),
            shiny::checkboxInput(
              inputId = "colour_code_check",
              label = "Colour-code data on the map",
              value = FALSE
            ),
            shiny::conditionalPanel(
              condition = "input.colour_code_check==true",
              shiny::radioButtons(
                inputId = "highlight_mode",
              ...
              shiny::conditionalPanel(
                condition = "input.highlight_mode=='Data columns'",
            ...
            shiny::checkboxInput(
              inputId = "geolocate_panel",
              label = "Geolocate points",
              value = FALSE
            ),
            shiny::conditionalPanel(
              condition = "input.geolocate_panel==true",
              shiny::radioButtons(
                inputId = "geolocate_selector",
                label = "Geolocate by",
                choices = c(
                  "Country (World)",
                  "NUTS0",
        ...
        mainPanel =
          shiny::mainPanel(
            ...
            shiny::downloadButton(
              outputId = "download_df_csv",
              label = "Download dataset (csv)"
            ),
            shiny::downloadButton(
              outputId = "download_df_ods",
              label = "Download dataset (ods)"
            ),
            shiny::downloadButton(
              outputId = "download_df_xlsx",
            ...
            shiny::hr(),
            shiny::downloadButton(
              outputId = "download_map_gg_png",
              label = "Download static map as image (png)"
            ),
            shiny::downloadButton(
              outputId = "download_map_gg_pdf",
              label = "Download static map as pdf"
            ),
            shiny::downloadButton(
              outputId = "download_map_lf_html",
