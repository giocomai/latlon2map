...
#'
#' @examples
ll_get_population_grid_hr <- function(
  geo,
  match_sf = NULL,
  match_name = NULL,
  ...
  if (!silent) {
    cli::cli_alert_info(paste(
      "Facebook Connectivity Lab and Center for International Earth Science Information Network - CIESIN - Columbia University. 2016. High Resolution Settlement Layer (HRSL). Source imagery for HRSL © 2016 DigitalGlobe. Accessed",
      Sys.Date()
    ))
    cli::cli_alert_info("License: Creative Commons Attribution International")
    cli::cli_alert_info(
      "Source: https://data.humdata.org/organization/facebook"
    )
  }
